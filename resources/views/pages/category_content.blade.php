...
@foreach($category_product as $vcategory_product)
<div class="col-md-4 product-men no-pad-men">
<div class="men-pro-item simpleCart_shelfItem">
	<div class="men-thumb-item">
		<img src="{{asset($vcategory_product->productImage)}}" height="249px"; width="255px"; alt="" class="pro-image-front">
		<img src="{{asset($vcategory_product->productImage)}}" height="249px"; width="255px"; alt="" class="pro-image-back">
	...
	<div class="item-info-product ">
				<h4><a href="{{url('/product-details/'.$vcategory_product->product_id)}}">{{$vcategory_product->productName}}</a></h4>
				<div class="info-product-price">
					<span class="item_price">{{$vcategory_product->productPrice}}</span>
					<del>$69.71</del>
				</div>
