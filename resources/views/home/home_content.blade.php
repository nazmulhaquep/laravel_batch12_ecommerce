...
<?php
      $slider_info = DB::table('homeslider')
                        ...
                        ->get();
?>
@foreach($slider_info as $vslider_image)
<li><img class="img-responsive" src="{{asset($vslider_image->slider_image)}}" alt="Dummy Image" /></li>
@endforeach
</ul>
...
<img src="{{asset($vdata->productImage)}}" height="249px"; width="255px"; alt="" class="pro-image-front">
<img src="{{asset($vdata->productImage)}}" height="249px"; width="255px"; alt="" class="pro-image-back">
...
<h4><a href="{{url('product-details/'.$vdata->product_id)}}">{{$vdata->productName}}</a></h4>
<div class="info-product-price">
<span class="item_price">{{$vdata->productPrice}}</span>
<del>$69.71</del>
</div>
<a href="{{URL::to('/add-to-cart/'.$vdata->product_id)}}" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
</div>
